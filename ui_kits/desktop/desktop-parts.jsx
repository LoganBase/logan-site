  ...
  return (
    <div style={{ background: '#0d1520', border: '1px solid #1e2d3d', borderRadius: 14, padding: '4px 18px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '8px 0 7px', borderBottom: '1px solid #1e2d3d' }}>
        ...
        <span style={{ fontFamily: DSANS, fontSize: 10, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: '#475569', flexShrink: 0, whiteSpace: 'nowrap' }}>Signal</span>
        <span style={{ fontFamily: DSANS, fontSize: 10, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: '#475569', flexShrink: 0, whiteSpace: 'nowrap' }}>Indicator</span>
        <span style={{ fontFamily: DSANS, fontSize: 10, fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: '#475569', flex: 1, minWidth: 0 }}>Condition</span>
      ...
      {rows.map((r, i) => {
        ...
        return (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '13px 0', borderBottom: i < rows.length - 1 ? '1px solid #16202e' : 'none' }}>
            ...
            <span style={{ fontFamily: DSANS, fontSize: 14, fontWeight: 600, color: '#e8edf5', flexShrink: 0, whiteSpace: 'nowrap' }}>{r[0]}</span>
            <span style={{ fontFamily: DSANS, fontSize: 12, color: '#64748b', flexShrink: 0, whiteSpace: 'nowrap' }}>{r[4]}</span>
            <span style={{ fontFamily: DSANS, fontSize: 12.5, color: '#94a3b8', flex: 1, minWidth: 0 }}>{r[2]}</span>
